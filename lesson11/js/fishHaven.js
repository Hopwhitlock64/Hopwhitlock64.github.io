...
/*Summary weather */
const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5585010&appid=c6353d1228c4dd7ed9a34d6ec9396b68"
...
document.getElementById('icon').setAttribute('alt', desc);
  ...
  const apiFive = "https://api.openweathermap.org/data/2.5/forecast?id=5585010&appid=c6353d1228c4dd7ed9a34d6ec9396b68"
  fetch(apiFive)
  .then((response) => response.json())
  .then((jsObject) => {
